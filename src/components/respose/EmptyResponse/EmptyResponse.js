  ...
  <div className={style.response}>
    ...
    <div className={style.inline}>
      ...
      <div className={style.text}>
        ...
        <p>
          Если у вас есть расчитанные акции, то вставьте их на вкладке
          &quot;тело ответа&quot;.
        </p>
    ...
    <div className={style.text}>
      ...
      <p>
        API Mindbox работает c XML и JSON, но сервис Pre4eker использует только
        JSON.
      </p>
      <p>
        Если у вас есть тело запроса или ответа в формате XML, то его можно
        вставить в соответствующей вкладке. После этого ваш запрос автоматически
        конвертируется в JSON.
      </p>
    </div>
    <div className={style.text}>
      <p>
